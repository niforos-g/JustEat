...
//
// The information printed, for the first 10 restaurants, are the name, rating, address and type of cuisine.
...
function displayRestaurants(restaurants) {
  ...
  restaurants.forEach(restaurant => {
    ...
    // the address is a compination of the firstLine + City + Postal Code
